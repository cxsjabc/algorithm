 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_GC2235MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::SCENE_MODE_NORMAL, 
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("2560x1920" /*2561x1921*/), 
            ITEM_AS_VALUES_(
                "320x240",     "640x480",    /*1280x790*/  "1024x768",     "1280x720",     "1280x768",     "1280x960", 
                "1600x1200",    "2048x1536",    "2560x1440",    "2560x1920",    "3264x2448",    "3328x1872", 
                "2880x1728",    "3600x2160",   /*"127x127"*/
                //"312x245",  "12x34", "128*128", 
            )
        ), 
    )
#endif
